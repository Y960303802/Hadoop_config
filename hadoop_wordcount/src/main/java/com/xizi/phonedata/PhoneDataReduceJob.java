...
//数据清洗
public class PhoneDataReduceJob extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        ToolRunner.run(new PhoneDataReduceJob(),args);
    }
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setJarByClass(PhoneDataReduceJob.class);
        ...
        //设置map
        job.setMapperClass(PhoneDataReduceJob.PhoneCleanDataMap.class);
        //下面修改了这里一定也要改 相对应
        ...
        //reduce
        job.setReducerClass(PhoneCleanDataReduce.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);
       //设置Output Format
        job.setOutputFormatClass(TextOutputFormat.class);
        //结果输出的位置
        Path res = new Path("/phonedata/res04");
    ...
    //shuffle 阶段
    //shoujihao [up down up down]

    public static  class PhoneCleanDataReduce extends Reducer<Text,Text,Text,Text>{
